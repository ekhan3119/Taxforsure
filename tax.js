...
$(function() {
  $('input[name="daterange"]').daterangepicker({
    ...
    var tues = moment(myDate, 'YYYY-MM-DD');
    var thing2 = tues.add(`1`, 'days').format('YYYY-MM-DD');
    console.log(thing2);

    var wed = moment(myDate, 'YYYY-MM-DD');
    var thing3 = wed.add(`2`, 'days').format('YYYY-MM-DD');
    console.log(thing3);

    var thurs = moment(myDate, 'YYYY-MM-DD');
    var thing4 = thurs.add(`3`, 'days').format('YYYY-MM-DD');
    console.log(thing4);

    var fri = moment(myDate, 'YYYY-MM-DD');
    var thing5 = fri.add(`4`, 'days').format('YYYY-MM-DD');
    console.log(thing5);

    var sat = moment(myDate, 'YYYY-MM-DD');
    var thing6 = sat.add(`5`, 'days').format('YYYY-MM-DD');
    console.log(thing6);

    var sun = moment(myDate, 'YYYY-MM-DD');
    var thing7 = sun.add(`6`, 'days').format('YYYY-MM-DD');
    console.log(thing7);
